...
extern "C"
{
    __device__ static const u32 Te0[256] = {
        0xc66363a5U,
        0xf87c7c84U,
        0xee777799U,
        0xf67b7b8dU,
    ...
    __device__ static const u32 Te1[256] = {
        0xa5c66363U,
        0x84f87c7cU,
        0x99ee7777U,
        0x8df67b7bU,
    ...
    __device__ static const u32 Te2[256] = {
        0x63a5c663U,
        0x7c84f87cU,
        0x7799ee77U,
        0x7b8df67bU,
    ...
    __device__ static const u32 Te3[256] = {
        0x6363a5c6U,
        0x7c7c84f8U,
        0x777799eeU,
        0x7b7b8df6U,
 ...
 */
    __device__ static void dev_AES_encrypt(const unsigned char *in, unsigned char *out,
                                           const AES_KEY *key)
    {
    ...
    __device__ static void dev_AES_ctr128_inc(unsigned char *counter)
    {
        unsigned long c;
