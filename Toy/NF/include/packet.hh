...
unsigned char *rte_pktmbuf_mtod(rte_mbuf *){};
uint32_t rte_pktmbuf_data_len(rte_mbuf *){};
uint32_t rte_pktmbuf_headroom(rte_mbuf *){};
uint32_t rte_pktmbuf_tailroom(rte_mbuf *){};

int rte_mbuf_refcnt_read(rte_mbuf *){};
void rte_pktmbuf_adj(rte_mbuf *, uint16_t){};
void rte_pktmbuf_append(rte_mbuf *, uint16_t){};
void rte_pktmbuf_trim(rte_mbuf *, uint16_t){};
...
public:
    ...
    { //return rte_pktmbuf_mtod(base, unsigned char *);
        return rte_pktmbuf_mtod(base);
    }
